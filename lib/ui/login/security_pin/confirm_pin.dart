      ...
      return BlocListener<PinScreenGenerateBloc,PinGenerateScreenState>(
        listener: (context,state){
          if(state.isTrue==true){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>VerifyPinScreen(data1: MemberId,)));
          }
          else{
                        ...
                        child: PinPut(
                          ...
                          onSubmit: (String pin) {
                            if (pin == StoredPin) {
                              ...
                              BlocProvider.of<PinScreenGenerateBloc>(context).add(PinGenerateScreenEvent(pin, Generate,int.parse(MemberId)));
